...
const App = (() => {
  ...
  const experiments = [
    ...
    },
    {
      ...
      details: "Centenas de fits iterativos em matriz de 100k features. RL supera baseline de 98.00% para 98.60%."
    },
    {
      id: 202,
      ...
      details: "Proxy (n_est=50, bagging=0.15) encontra config otima; MAE 1.4297 empata com Optuna (1.4218) em fracao do tempo."
    },
    {
      id: 1,
      title: "Senti-Pred Pipeline A (Agressivo)",
      category: "nlp-sentiment",
      categoryLabel: "NLP - Sentimento",
      status: "completed",
    ...
    {
      id: 2,
      title: "Senti-Pred Pipeline B (Conservador)",
      category: "nlp-sentiment",
      categoryLabel: "NLP - Sentimento",
      status: "completed",
      ...
      dataset: "Twitter Entity Sentiment (74k)",
      details: "Preserva conteudo de hashtags e contracoes idiomaticas."
    },
    {
      id: 3,
    ...
    {
      id: 4,
      title: "Pipeline A vs B vs C (Duelo + Ablacoes)",
      category: "nlp-sentiment",
      categoryLabel: "NLP - Sentimento",
      status: "completed",
    ...
    {
      id: 7,
      title: "Senti-Pred Pipeline Corrigido",
      category: "nlp-sentiment",
      categoryLabel: "NLP - Sentimento",
      status: "completed",
      description: "Pipeline corrigido com validacao estrita e remocao de vazamento de dados.",
      ...
      dataset: "Twitter Entity Sentiment (74k)",
      details: "Validacao cruzada estratificada e pipeline desacoplado para producao confiavel."
    },
    {
      id: 10,
    ...
    {
      id: 41,
      title: "Clustering: Flat vs Hierarquico",
      category: "hierarchical",
      categoryLabel: "Hierarquico",
      status: "completed",
    ...
    {
      id: 45,
      title: "Feature Selection Evolucionaria (GAAP/MO-DE)",
    ...
    {
      id: 51,
      title: "Animal Multi-Label (4 Abordagens)",
      category: "cv",
      categoryLabel: "Computer Vision",
      status: "completed",
    ...
    },
    {
      ...
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "LSTM+Attention->TCN: Student retem 103.9% do Teacher. LGBM->LGBM falha.",
    ...
    {
      id: 71,
      title: "TS Feature Engineering Fase 1 — Manual vs tsfresh",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Engenharia de features manual (lags, rolling) vs automatica (tsfresh) em temperatura diaria.",
      ...
      dataset: "Daily Min Temperatures",
      details: "Features manuais reduzem dimensionalidade e vencem tsfresh em velocidade e estabilidade."
    },
    {
      id: 72,
      title: "TS Feature Engineering Fase 2 — Multivariada (Beijing PM2.5)",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Feature engineering multivariada em 5 variaveis climaticas simultaneas (Temperatura, Vento, Pressao).",
      ...
      details: "Lags cruzados capturam dinâmica meteorologica antes de picos de poluição."
    },
    {
      id: 73,
      title: "TS Feature Engineering Fase 3 — Deep Learning Embeddings",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "LSTM Autoencoder em PyTorch para extrair representacoes latentes e comprimir janelas temporais.",
      ...
      details: "Compressao de 35 features em 16 dimensoes latentes para alimentar arvores de decisao."
    },
    {
      id: 74,
      title: "TS Feature Engineering Fase 4 — Sinais & Wavelets (DWT)",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Transformada Wavelet Discreta (DWT) e Decomposicao Sazonal sem vazamento temporal.",
      ...
      dataset: "Beijing PM2.5",
      details: "DWT em janelas deslizantes quebra o recorde anterior (MAE 54.19 vs 56.80)."
    },
    {
      id: 75,
      title: "TS Feature Engineering Fase 5 — Time Embeddings & HPO",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Time embeddings trigonometricos (seno/cosseno) e otimizacao bayesiana via Optuna.",
      ...
      dataset: "Beijing PM2.5",
      details: "Harmonicos temporais eliminam descontinuidade entre o final e inicio de ciclos anuais."
    },
    {
      id: 76,
      title: "Sktime vs Hybrid (Fase 6)",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      ...
      dataset: "Beijing PM2.5",
      details: "sktime WindowSummarizer quebra recorde com MAE 52.79 em menos de 1s de execucao."
    },
    {
      id: 77,
      ...
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Modelagem simultanea de PIB, Consumo, Investimento e Inflacao via VAR com selecao AIC/BIC.",
      ...
      details: "Captura choques interconectados (IRF). Modelagem multivariada supera ARIMA univariado isolado."
    },
    {
      id: 78,
      ...
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Previsao de vendas imobiliarias com transformacao Box-Cox, variaveis exogenas e Prophet.",
      ...
      details: "Box-Cox estabiliza heterocedasticidade severa. SARIMAX multivariado reduz erro em 38%."
    },
    {
      id: 79,
      title: "Sales Forecast — Forecaster sktime Integrado",
      category: "timeseries",
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Modulo de treinamento e inferencia para Sales Forecast utilizando pipelines sktime.",
      ...
      details: "Implementacao orientada a objetos (OOP) pronta para integracao de microsservicos."
    },
    {
      id: 601,
      ...
      categoryLabel: "Series Temporais",
      status: "completed",
      description: "Previsao hierarquica temporal com reconciliacao bottom-up vs forecast direto do Total (Total -> Regioes -> Folhas).",
      ...
      details: "Estrutura hierarquica em 3 niveis (Total -> Regioes R1/R2 -> Folhas A1/A2/B1/B2). Reconciliação bottom-up garante coerencia aditiva na arvore."
    },
    {
      id: 80,
      title: "Anomaly: Supervised vs Unsupervised",
      category: "anomaly",
      categoryLabel: "Deteccao de Anomalias",
      status: "completed",
    ...
    {
      id: 82,
      title: "Anomaly Detection Time Series Otimizada",
      category: "anomaly",
      categoryLabel: "Deteccao de Anomalias",
      status: "completed",
      description: "Pipeline otimizado para deteccao de anomalias em series temporais com tuning de thresholds.",
      ...
      details: "Calibracao de limiares estatisticos para minimizar falsos positivos em monitoramento."
    },
    {
      id: 85,
    ...
    {
      id: 93,
      title: "California Housing — Estrategias de Regressao Avancada",
      category: "regression",
      categoryLabel: "Regressao Tabular",
      status: "completed",
      description: "Estudo comparativo: Univariada, Multipla, Ridge+RFE, Random Forest e Gradient Boosting.",
      ...
      dataset: "California Housing (20.6k)",
      details: "Feature engineering geografico (distancia a polos economicos) melhora R2 de 0.60 para 0.8034."
    },
    {
      id: 95,
    ...
    {
      id: 97,
      title: "IBM Watsonx — Sentimentos (Cloud)",
      category: "ibm",
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
    ...
    {
      id: 98,
      title: "IBM AutoAI — Montador de Pipeline Electric Production",
      category: "ibm",
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
      description: "Representacao Scikit-learn do pipeline exportado pelo Watsonx AutoAI para series temporais.",
      techniques: ["autoai-ts-libs", "Scikit-Learn Pipeline", "Holdout Evaluation", "IBM Cloud Deployment"],
      metric: null,
      script: "experiments/ibm-experiments/_P4 - Montador_ Electric_Production.ipynb",
      readme: "experiments/ibm-experiments/README.md",
      models: ["AutoAI Exported Pipeline"],
      dataset: "Electric Production",
      details: "Pipeline de scoring e forecasting gerado com definicao oficial de operacoes Scikit-Learn."
    },
    {
      id: 99,
      title: "IBM AutoAI — Classificador Snap Random Forest",
      category: "ibm",
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
      description: "Pipeline de classificacao com aceleracao Snap ML exportado do IBM Watsonx.",
      ...
      details: "Implementacao com aceleracao nativa Snap ML para inferencia ultra veloz."
    },
    {
      id: 101,
      title: "IBM AutoAI — Regressor Snap Random Forest",
      category: "ibm",
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
      description: "Pipeline de regressao com Snap ML Random Forest Regressor exportado do IBM Watsonx.",
      ...
      details: "Modelo treinado em AutoAI com transformacoes matematicas automatizadas."
    },
    {
      id: 102,
      ...
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
      description: "Notebook gerado pelo Databricks AutoML utilizando modelo probabilistico DeepAR em PyTorch/GluonTS.",
      ...
      details: "Rede neural recorrente autorregressiva para distribuicoes de probabilidade de demanda."
    },
    {
      id: 103,
      ...
      categoryLabel: "IBM Watsonx / Databricks",
      status: "external",
      description: "Notebook gerado pelo Databricks AutoML com tuning via Hyperopt e SparkTrials.",
      ...
      dataset: "quantity_sales_transactions",
      details: "Hiperparametrizacao distribuida no Apache Spark com rastreamento no MLflow."
    },
    {
      id: 104,
